...
echo '<div class="tile '.$dataType.'" style="background-image:' . base64_encode($row['mediaselection']). ';" width=290" height="290"></div>';
// echo '<div class="tile image" style="background-image:' . base64_encode($row['mediaselection']). ';" width=290" height="290"></div>';
    // echo '<br>';
